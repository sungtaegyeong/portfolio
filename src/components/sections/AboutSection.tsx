...
export function AboutSection() {
  return (
    ...
    >
      <div className="grid gap-4 text-lg leading-8 text-[var(--muted)] md:grid-cols-[1fr_1fr]">
        <p className="rounded-[28px] border border-[var(--border)] bg-white p-6 shadow-[0_12px_36px_rgba(25,31,40,0.04)]">
